        ...
        {currentUser.role === 'admin' ? (
          <>
            <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 'var(--radius2)', padding: '18px 16px' }}>
              ...
              <div style={{ fontSize: '12px', color: 'var(--text2)' }}>Company Net Profit</div>
            ...
            <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 'var(--radius2)', padding: '18px 16px' }}>
              ...
              <div style={{ fontSize: '12px', color: 'var(--text2)' }}>Total Client Income</div>
            ...
            <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 'var(--radius2)', padding: '18px 16px' }}>
              ...
              <div style={{ fontSize: '12px', color: 'var(--text2)' }}>Monthly Salaries Paid</div>
            ...
            <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 'var(--radius2)', padding: '18px 16px' }}>
              ...
              <div style={{ fontSize: '12px', color: 'var(--text2)' }}>Operating Expenses</div>
